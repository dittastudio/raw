    ...
    for (const post of posts) {
      ...
      try {
        ...
        const fields = {
          ...
          seo_title: decodeHtmlEntities(post.yoast_head_json?.og_title || '') || decodeHtmlEntities(post.yoast_head_json?.title || '') || postTitle || '',
          seo_description: decodeHtmlEntities(post.yoast_head_json?.og_description || '') || decodeHtmlEntities(post.yoast_head_json?.description || '') || postTitle || '',
          seo_image: postImage,
          hero: postImage,
